...
builds:
  ...
  - name: True Courage (DPS)
    ...
    playstyle: Build identity gauge through normal skills, then buff yourself to unlock and cast a concentrated damage attack. Non-directional, but melee damage dealer.
    difficulty: easy
    identity:
      name: Serenade of Courage / Tempest
      description: Upon Serenade of Courage use, grants yourself a 5/10/15% damage buff for 8/12/16 seconds based on the number of bubbles consumed. Unlocks Tempest skill, which will wind up a concentrated attack. Tempest is the crux of the True Courage build.
    synergy:
    ...
    variants:
      - name: Standard (112)
        difficulty: 1
        recommended: true
        description: Standard True Courage build, is the upgraded version of Pre-Ark Grid True Courage. Ark Grid amplifies your meter generation and in turn increases damage output. Flexible sending consistent 2-bubbles or saving up for 3-bubble burst windows. Sound Blitz star core is recommended. 
